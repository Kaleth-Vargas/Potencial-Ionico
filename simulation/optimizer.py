...
# Where SIMION itself is installed. Defaults to this same folder (copy
# simion.exe next to this script, as the README says). Only change this if
# SIMION lives somewhere else on your computer.
SIMION_INSTALL_DIR = SIM_FOLDER

# Where to save your results (in the repo-level data/ folder).
_DATA_DIR   = SIM_FOLDER.parent / "data"
RESULTS_DB  = _DATA_DIR / "beamline_study.db"
RESULTS_CSV = _DATA_DIR / "beamline_results.csv"
...
STARTING_POINT = {
    "V3": -533.92, "V6": -861.2, "V9": 621.11, "V10": 48.47,
    "V11": 122.0, "V12": -491.87, "V15": -872.14, "V18": 186.12
}
